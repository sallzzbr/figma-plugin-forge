...
- [optional-backend pattern](../../plugin-architecture/references/patterns/optional-backend.md) — when to add a backend at all
- [messaging-bridge pattern](../../plugin-architecture/references/patterns/messaging-bridge.md) — how to document contracts
- [llm-analysis pattern](../../plugin-architecture/references/patterns/llm-analysis.md) — archetype that uses this snippet
