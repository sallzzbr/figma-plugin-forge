...
- The `MainToUiMessage` and `UiToMainMessage` unions are the same shapes the UI side declares. Both sides must stay in sync, which is why the contract is documented in [messaging-bridge.md](../../../plugin-architecture/references/snippets/messaging-bridge.md).
...
- [messaging-bridge snippet](../../../plugin-architecture/references/snippets/messaging-bridge.md) — exemplar contract table format
- [ui-iframe snippet](ui-iframe.md) — matching UI-side handler
- [runtime-split pattern](../../../plugin-architecture/references/patterns/runtime-split.md) — which side owns which concern
- [messaging-bridge pattern](../../../plugin-architecture/references/patterns/messaging-bridge.md) — how to document the contract itself
