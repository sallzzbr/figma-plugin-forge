...
See [main-thread.md](snippets/main-thread.md) and [ui-iframe.md](snippets/ui-iframe.md) for the full typed messaging pattern.
...
- [project-setup.md](../../plugin-architecture/references/project-setup.md) — how to set up a working plugin project
- [runtime-split pattern](../../plugin-architecture/references/patterns/runtime-split.md) — which side owns which API
- [messaging-bridge snippet](../../plugin-architecture/references/snippets/messaging-bridge.md) — typed message contract
