...
- [Component Spec Extractor example](../../../writing-plans/references/examples/2026-04-09-spec-generation-design-doc-example.md) — end-to-end design doc proving this pattern
...
- [optional-backend snippet](../../../figma-backend-integration/references/optional-backend-snippet.md) — typed backend call with error handling
- [figma-api-reference](../../../figma-api-patterns/references/api-reference.md) — node traversal, variables, fills, export
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — type narrowing, mixed fills, export constraints
