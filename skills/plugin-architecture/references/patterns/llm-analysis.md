...
- [Frame Review Assistant example](../../../writing-plans/references/examples/2026-04-08-design-doc-example.md) — end-to-end design doc proving this pattern
...
- [optional-backend snippet](../../../figma-backend-integration/references/optional-backend-snippet.md) — typed request/response/error
- [figma-api-reference](../../../figma-api-patterns/references/api-reference.md) — export API, selection, image handling
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — unbounded exports, imageHash confusion
