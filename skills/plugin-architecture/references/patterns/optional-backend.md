...
- [optional-backend snippet](../../../figma-backend-integration/references/optional-backend-snippet.md) — typed request/response/error with injected auth
...
- [figma-api-reference](../../../figma-api-patterns/references/api-reference.md) — export API for sending frames to backend
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — pitfall #9 (fetch in main), #12 (missing networkAccess)
