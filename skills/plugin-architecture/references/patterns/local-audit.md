...
- [Contrast Auditor example](../../../writing-plans/references/examples/2026-04-09-local-audit-design-doc-example.md) — end-to-end design doc proving this pattern
...
- [figma-api-reference](../../../figma-api-patterns/references/api-reference.md) — node traversal, selection, fills
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — type narrowing, empty selection, mixed fills
