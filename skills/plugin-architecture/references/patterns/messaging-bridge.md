...
- [main-thread snippet](../../../figma-api-patterns/references/snippets/main-thread.md) — matching main-side handler with type guard
- [ui-iframe snippet](../../../figma-api-patterns/references/snippets/ui-iframe.md) — matching UI-side handler with type guard
- [runtime-split](runtime-split.md) — which side sends which messages
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — pitfall #4 (raw nodes to UI), #8 (figma in UI)
