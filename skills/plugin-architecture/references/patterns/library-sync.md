...
- [figma-api-reference](../../../figma-api-patterns/references/api-reference.md) — variables, styles, component properties
- [common-pitfalls](../../../figma-api-patterns/references/common-pitfalls.md) — async variable methods, type narrowing
