...
**Related pattern(s)**: [`spec-generation`](../../../plugin-architecture/references/patterns/spec-generation.md), [`runtime-split`](../../../plugin-architecture/references/patterns/runtime-split.md), [`messaging-bridge`](../../../plugin-architecture/references/patterns/messaging-bridge.md), [`optional-backend`](../../../plugin-architecture/references/patterns/optional-backend.md)
**Related plan**: [`2026-04-09-spec-generation-implementation-plan-example.md`](2026-04-09-spec-generation-implementation-plan-example.md)
