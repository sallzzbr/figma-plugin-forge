...
**Related pattern(s)**: [`local-audit`](../../../plugin-architecture/references/patterns/local-audit.md), [`runtime-split`](../../../plugin-architecture/references/patterns/runtime-split.md), [`messaging-bridge`](../../../plugin-architecture/references/patterns/messaging-bridge.md)
**Related plan**: [`2026-04-09-local-audit-implementation-plan-example.md`](2026-04-09-local-audit-implementation-plan-example.md)
